...
import '../contact.css';
import chibiContact from '../assets/images/company-icon-floating.png'
function Contact() {
    return (
        <main>
            ...
            <div id="contactFormDiv" className="container">
                ...
                <div className="col-md-12">
                    ...
                    <form className="client-form" action="https://formsubmit.co/bf08c4938b1b5a7ebce82ff857e28784" method="POST">
                        ...
                        <input type='hidden' name="_next" value="http://www.spacebarr.net/confirm" /> {/* needs to be changed to actual domain */}
